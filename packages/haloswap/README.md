...
This is a collection of common types and the queriers which are commonly used in halo contracts.
...
It also provides the query interface to query avaliable halo pair contract info. Any contract can query pair info to halo factory contract.
...
It also provides the query interface to query avaliable halo pair contract info. Any contract can query pair info to pair contract.
